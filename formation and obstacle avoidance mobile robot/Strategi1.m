...
%% Create a folder to save figures
    outputFolder = fullfile(pwd, 'figure', '/Strategi1');
...
for idx = 2:numel(tVec)
        ...
        for j = i+1:numRobots
            ...
            if distance < collisionThreshold
                if ~inCollision(i, j)
                    ...
                    disp(['Collision detected between Robots ', num2str(i), ...
                          ' with Robot ', num2str(j), ' at the t = ', num2str(tVec(idx)), ' s']);
    ...
    velB2 = [v_safe2; 0; w_safe2];
    velB3 = [v_safe3; 0; w_safe3];
    velB4 = [vRef4; 0; wRef4];
    velB5 = [vRef5; 0; wRef5];
